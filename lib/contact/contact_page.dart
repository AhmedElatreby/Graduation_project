...
class ContactPage extends StatefulWidget {
  ContactPage({required Key key, required this.title}) : super(key: key);
...
class _ContactPageState extends State<ContactPage> {
  ...
  List<EmergencyContacts> contactsFiltered = [];
  ...
  getAllContacts() async {
    ...
    List<EmergencyContacts> _contacts =
      ...
      return new EmergencyContacts(info: contact, color: baseColor);
    }).toList();
    setState(() {
      contacts = _contacts;
      contactsLoaded = true;
      ...
      _contacts.retainWhere(
        (contact) {
          ...
          var phone = contact.info.phones?.firstWhere(
            (phn) {
              String phnFlattened = flattenPhoneNumber(flattenPhoneNumber(contactName));
